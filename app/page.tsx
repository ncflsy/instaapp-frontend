        ...
        <section id="home" className="flex flex-col gap-3 px-2">
            ...
            <div className="flex flex-col gap-4">
                {Array.from({ length: 10 }).map((_, i) => (
                    <div key={i} className="card flex flex-col items-center w-full border border-gray-100/30 rounded-lg">
                        ...
                        <div className="flex w-full h-[400px] justify-center items-center bg-gray-400">
                            <Image src={`https://picsum.photos/seed/${i + 1}/580/625`} width={380} height={400} alt="post"></Image>
                        </div>
