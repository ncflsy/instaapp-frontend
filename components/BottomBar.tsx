...
export default function bottombar() {
    return (
        <div className="w-full py-4 px-16 flex border-t-[1px] border-gray-700 bg-black/80 backdrop-blur-xs fixed bottom-0 gap-4 justify-between items-center md:max-w-[800px] mx-auto">
            <Link href="/">
